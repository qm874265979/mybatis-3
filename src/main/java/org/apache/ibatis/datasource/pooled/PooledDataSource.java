...
public class PooledDataSource implements DataSource {
  ...
  /**
   * UnpooledDataSource 对象。获取真正连接的逻辑，还是在 UnpooledDataSource 中实现。
   */
  ...
  public Connection getConnection() throws SQLException {
    //返回代理的 Connection 对象。这样，每次对数据库的操作，才能被 PooledConnection 的 invoke 代理拦截。
  ...
  /**
   * 将使用完的连接，添加回连接池中
   * 该方法会被 PooledConnection 的 {@link PooledConnection#invoke(Object proxy, Method method, Object[] args)} 在 methodName = close 方法的情况下时被调用。
   */
