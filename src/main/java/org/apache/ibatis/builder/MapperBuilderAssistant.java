...
/**
 * 继承 BaseBuilder 抽象类，Mapper 构造器的小助手，提供了一些公用的方法，例如创建 ParameterMap、MappedStatement 对象等
...
public class MapperBuilderAssistant extends BaseBuilder {
  ...
  private ParameterMap getStatementParameterMap(
    ...
    if (parameterMapName != null) {
      ...
      // <1> 如果 parameterTypeClass 非空，则创建 ParameterMap 对象.MyBatis 官方不建议使用 parameterMap 的方式。
  ...
  private List<ResultMap> getStatementResultMaps(
    ...
    if (resultMap != null) {
      //比较奇怪的是，方法参数 resultMap 存在使用逗号分隔的情况。这个出现在使用存储过程的时候，参见<a href="https://blog.csdn.net/sinat_25295611/article/details/75103358">mybatis调用存储过程返回多个结果集</a>
